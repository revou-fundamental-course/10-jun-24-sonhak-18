...
![Screenshot of Temperature Converter](https://telegra.ph/file/57736194a893f0aa0d9e1.png)
...
### Installation
1. **Clone the Repository (RevoU)**
   ```bash
   git clone https://github.com/revou-fundamental-course/10-jun-24-sonhak-18
2. **Clone the Repository (sonhak-18)**
   ```bash
